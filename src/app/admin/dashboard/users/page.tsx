...
export default function AdminUsersPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 font-sans py-8 p-4 md:p-8 w-full">
      ...
      <div className="bg-white border border-slate-200 rounded-[2rem] overflow-hidden shadow-sm w-full">
                    ...
                    <tr key={user.id || idx} className="hover:bg-slate-50/50 transition-colors group">
                      <td className="px-6 py-5">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <span className="font-bold text-[15px] text-slate-900">{user.name || "Guest User"}</span>
                            <div className="text-[11px] font-bold text-slate-400 mt-0.5 uppercase tracking-wide">ID: {user.id.substring(0,8)}...</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-5">
                      ...
                      <td className="px-6 py-5">
                        <span className="text-sm font-medium text-slate-500">{formatDate(user.createdAt)}</span>
                      </td>
                      <td className="px-6 py-5">
